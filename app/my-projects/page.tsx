...
const Page = () => {
  return (
    <div
      ...
      className="w-screen h-screen flex items-center justify-center bg-center bg-cover overflow-hidden"
    >
      <div className="flex flex-col items-center justify-center w-full max-w-6xl px-4 h-full pt-24 md:pt-0 pb-10">
